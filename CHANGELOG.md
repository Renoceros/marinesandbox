...
### Fixed
- Fixed letterboxing and vertical squishing bugs on background and midground parallax layers in [`ParallaxScrollView.swift`](marinesandbox/Views/Canvas/ParallaxScrollView.swift) by forcing full-bleed segment height frames and applying `.fill` scaling.
